...
public class OfficesApiResource {
    ...
    private final Set<String> RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList("id", "name", "nameDecorated", "externalId",
            "openingDate", "hierarchy", "parentId", "parentName", "allowedParents","cin",
            "companyName","companyStatus","roc","funds","incorporatedDate",
            "registrationAddress","registrationNumber"));
    ...
    public String retrieveOffices(@Context final UriInfo uriInfo,
        ...
        logger.info("offices  =  includeAllOffices================**************************************=");
		...
		logger.info(offices+"offices  =  includeAllOffices================**************************************=");
