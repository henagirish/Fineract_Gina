...
public class OfficeData implements Serializable {
	...
	private final LocalDate incorporatedDate;
	...
	public static OfficeData importInstance(final String name, final Long parentId, final LocalDate openingDate,
		...
		return new OfficeData(null, name, null, externalId, openingDate, null, parentId, null, null, null, null, null,
				null, null, null, null, null);
		// cin, roc,companyName,
		// companyStatus,registrationNumber,registrationAddress, funds,
		// openingDate);
	}
	...
	public static OfficeData dropdown(final Long id, final String name, final String nameDecorated) {
		return new OfficeData(id, name, nameDecorated, null, null, null, null, null, null, null, null, null, null, null,
				null, null, null);
	}

	public static OfficeData template(final List<OfficeData> parentLookups, final LocalDate defaultOpeningDate) {
		return new OfficeData(null, null, null, null, defaultOpeningDate, null, null, null, parentLookups, null, null,
	...
	public static OfficeData appendedTemplate(final OfficeData office, final Collection<OfficeData> allowedParents) {
		return new OfficeData(office.id, office.name, office.nameDecorated, office.externalId, office.openingDate,
				office.hierarchy, office.parentId, office.parentName, allowedParents, null, null, null, null, null,
				null, null, null);
	}

	public OfficeData(final Long id, final String name, final String nameDecorated, final String externalId,
			final LocalDate openingDate, final String hierarchy, final Long parentId, final String parentName,
			final Collection<OfficeData> allowedParents, final String cin, final String roc, final String companyName,
			final String companyStatus, final Integer registrationNumber, final String registrationAddress,
			final Integer funds, final LocalDate incorporatedDate) {
		this.id = id;
		this.name = name;
