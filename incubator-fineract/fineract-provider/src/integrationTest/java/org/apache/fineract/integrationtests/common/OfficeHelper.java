...
public class OfficeHelper {
	...
	public Integer createOffice(final String openingDate, final String cin, final String roc, final String companyName,
			final String companyStatus, final String registrationNumber, final String registrationAddress,
			final String funds, final String incorporatedDate) {
		String json = getAsJSON(openingDate, cin, roc, companyName, companyStatus, registrationNumber,
	...
	public static String getAsJSON(final String openingDate, final String cin, final String roc,
			final String companyName, final String companyStatus, final String registrationNumber,
			final String registrationAddress, final String funds, final String incorporatedDate) {
		...
		/*
		 * New Fields added by Aiswarya on Aug 30
		 */
		...
		map.put("incorporatedDate", incorporatedDate);
		map.put("funds", funds);
		map.put("registrationAddress", registrationAddress);
